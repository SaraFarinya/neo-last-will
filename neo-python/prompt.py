...
from neo.Prompt.HelperGUI.GUI import HelperGUI # >>>
...
class PromptInterface(HelperGUI): # >>> new parent: object --> HelperGUI
    go_on = True
    ...
    def __init__(self):
        super(PromptInterface, self).__init__() # >>> HelperGUI __init__
    ...
    def quit(self):
        ...
        # >>> Note: this code has changed in the latest neo-python merge from dev
        ...
        while self.go_on:
            ...
            try:
                ...
                if command is not None and len(command) > 0:
                    ...
                    elif command == 'gui': # >>> added this new GUI branch
                        self.gui_on = True # >>>
